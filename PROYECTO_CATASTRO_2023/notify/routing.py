...
from notify import consumers as consumers_notify
...
websocket_urlpatterns = [
    #path('ws/load_notify/<str:username>/', consumers_notify.NotifyConsumer.as_asgi()),
    #path('prueba/',consumers_notify.TestConsumer.as_asgi())
]
